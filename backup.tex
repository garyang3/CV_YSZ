...
\section{Courses and Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Advanced Phyiscs Coursework}: General Relativity, Quantum Field Theory (I,II), Cosmological Physics,  Condensed Matter Physics, Liquid Crystal, The Interstellar Medium
        
        \textbf{Advanced Mathematics Coursework}: Differential Geometry, Complex Analysis, Modern Algebra (I, II), Analytical Number Theory, Stochastic Processes and Numerical Methods, Knot Theory
